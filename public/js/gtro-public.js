jQuery(document).ready(function ($) {
    ...
    // Ajoutez un log avant la soumission du formulaire
    $("form.cart").on("submit", function () {
        console.log("Form submitted");
        console.log("Vehicle:", $('input[name="gtro_vehicle"]').val());
        console.log("Date:", $('select[name="gtro_date"]').val());
    });
});
